...
public class StreamUtils {
    ...
    // -- get numbers -- /
    public static short readFirstShort(BufferedInputStream inputStream) throws IOException {
        return ByteBuffer.wrap(inputStream.readNBytes(2)).getShort();
    }

    public static int readFirstInt(BufferedInputStream inputStream) throws IOException {
        return ByteBuffer.wrap(inputStream.readNBytes(4)).getInt();
    }

    public static Long readFirstLong(BufferedInputStream inputStream) throws IOException {
        return ByteBuffer.wrap(inputStream.readNBytes(8)).getLong();
    }

    public static Float readFirstFloat(BufferedInputStream inputStream) throws IOException {
        return ByteBuffer.wrap(inputStream.readNBytes(4)).getFloat();
    }

    public static Double readFirstDouble(BufferedInputStream inputStream) throws IOException {
